...
TEST02=$(cat <<EOL
[1,2000000000,]{2000000000,2000000000,294967295,4294967295,}
EOL
)
...
TEST04=$(cat <<EOL
[5,10,]{1,3,5,7,10,25,4294967295,}dodatak
EOL
)
...
TEST05=$(cat <<EOL
[5,10,]{1,3,5,7,10,25,4294967296,}dodatak
EOL
)
